  ...
  return (
    ...
    >
      ...
      <LegalSection title="Pesquisa no catálogo aberto de restaurantes">
        Na aplicação MesaLink Partners, utilizamos um diretório verificado pelo MesaLink e podemos utilizar a Geoapify e dados do OpenStreetMap como complemento de localização. A pesquisa, a zona indicada e, apenas quando autorizada pelo utilizador, a localização aproximada podem ser transmitidas à Geoapify para devolver resultados adicionais. Para criar e atualizar o diretório, consultamos informação pública do site oficial associado ao restaurante. Só publicamos registos que mantenham um email público utilizável para o pedido de reserva e uma fotografia real do próprio estabelecimento. O MesaLink conserva os identificadores dos locais, contactos, fotografias por referência, respetivas páginas de origem e datas de verificação, bem como os dados necessários para gerir pedidos de reserva. Aplicam-se também a <a href="https://www.geoapify.com/privacy-policy/" target="_blank" rel="noreferrer" className="font-semibold text-[#9B6F3B] underline">Política de Privacidade da Geoapify</a> e a <a href="https://osmfoundation.org/wiki/Privacy_Policy" target="_blank" rel="noreferrer" className="font-semibold text-[#9B6F3B] underline">Política de Privacidade do OpenStreetMap</a>.
      </LegalSection>
