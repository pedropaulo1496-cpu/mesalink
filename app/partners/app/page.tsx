...
import PartnerReservationCancelButton from "@/components/partners/PartnerReservationCancelButton";
...
function partnerPaymentLabel(status?: string, groupStatus?: string) {
  if (groupStatus === "CANCELLED") return "Sem comissão";
