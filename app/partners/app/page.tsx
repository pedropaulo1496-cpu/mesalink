...
export default async function PartnerAppPage({
  ...
  const restaurantOptions = restaurants.map((restaurant) => {
    ...
    return {
      ...
      ratingSource: restaurant.googleRating != null ? "GOOGLE" : isDemo ? "DEMO" : "",
      websiteUrl: `/s/${restaurant.slug}`,
      openingHours: "",
