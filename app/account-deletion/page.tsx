    ...
    <main className="min-h-screen bg-[#F5EFE6] text-[#16120E]">
      ...
      <section className="mx-auto max-w-4xl px-5 py-12 sm:py-16">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-[#6B6258]">
          Esta página aplica-se à app MesaLink para restaurantes e explica como pedir a eliminação da conta e dos dados associados.
        </p>
        ...
        <div className="mt-10 space-y-8 rounded-[32px] border border-[#E1D0B8] bg-white p-6 text-[#6B6258] shadow-[0_22px_70px_rgba(80,55,30,0.055)] sm:p-8">
          <section>
            ...
            <ol className="mt-3 list-decimal space-y-2 pl-5 leading-relaxed">
              <li>Envie um email a partir do endereço associado à conta para <a className="font-semibold text-[#9B6F3B] underline" href="mailto:info@mesalink.pt?subject=Eliminar%20conta%20MesaLink">info@mesalink.pt</a>.</li>
              <li>Use o assunto <strong>Eliminar conta MesaLink</strong> e indique o nome da conta e do restaurante.</li>
              <li>A MesaLink pode pedir uma confirmação adicional para impedir pedidos não autorizados.</li>
            </ol>
          ...
          <section lang="en">
            ...
            <p className="mt-3 leading-relaxed">To delete your MesaLink account and associated data, email <strong>info@mesalink.pt</strong> from the address linked to your account with the subject “Delete MesaLink account”. Requests are completed within 30 days. Legally required billing, tax, fraud-prevention and dispute records may be retained for the applicable statutory period; protected backup copies are removed within 90 days. You may also request deletion of specific data without closing your account.</p>
          </section>
        </div>
      </section>
