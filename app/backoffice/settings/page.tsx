...
export default async function BackofficeSettingsPage() {
  await requireStaff();
  return <><PageHeading eyebrow="Preferências" title="Definições" description="Controla os avisos do HQ neste dispositivo." /><div className="mt-6 max-w-3xl space-y-5"><HqPushNotifications /><AccountDeletionButton accountLabel="MesaLink HQ" /></div></>;
}
