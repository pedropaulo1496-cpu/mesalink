    ...
    <div className="grid gap-10 md:grid-cols-3">
      <div className="text-center">
        ...
        <h3 className="mb-4 text-2xl font-black">
          Adicione o link ao Google Maps
        </h3>

        <p className="leading-relaxed text-[#a99a82]">
          Coloque o link do MesaLink no perfil Google do restaurante,
          Instagram ou website.
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="mb-4 text-2xl font-black">
          O cliente reserva online
        </h3>

        <p className="leading-relaxed text-[#a99a82]">
          Escolhe data, hora e número de pessoas sem telefonemas nem mensagens.
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="mb-4 text-2xl font-black">
          Receba a reserva instantaneamente
        </h3>

        <p className="leading-relaxed text-[#a99a82]">
          Confirme, aprove ou organize tudo diretamente no painel MesaLink.
        </p>
      </div>
    </div>
  </div>
