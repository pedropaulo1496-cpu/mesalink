...
const salesCopy = {
  pt: {
    ...
    appsText: "A app do restaurante acompanha a operação. Partners e HQ têm contas e permissões próprias.",
  ...
  en: {
    ...
    appsText: "The restaurant app follows daily operations. Partners and HQ have separate accounts and permissions.",
