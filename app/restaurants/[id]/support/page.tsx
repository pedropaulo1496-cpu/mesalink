...
export default async function SupportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8F2E8] text-[#17130F] lg:pl-[286px]">
      ...
      <main className="mx-auto max-w-5xl px-4 pb-28 pt-6 sm:px-7 lg:pb-10 lg:pt-9">
        <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#A97936]">Apoio ao cliente</p>
        <h1 className="mt-2 text-3xl font-black tracking-[-0.04em] sm:text-4xl">Como podemos ajudar?</h1>
        <p className="mb-6 mt-2 text-sm text-[#776B5E]">Fala diretamente com a equipa MesaLink sem sair da aplicação.</p>
