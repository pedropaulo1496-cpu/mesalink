      ...
      <div className="grid min-h-screen lg:grid-cols-[286px_1fr]">
        ...
        <section className="min-w-0 px-4 pb-28 pt-5 sm:px-6 lg:px-8 lg:py-7">
          ...
          <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <span className={`inline-flex w-fit items-center gap-2 rounded-full border px-4 py-2 text-[9px] font-black uppercase tracking-[0.12em] ${restaurant.referralAutoAcceptEnabled ? "border-[#A8D3A6] bg-[#EFF9EF] text-[#3F6A4D]" : "border-[#DCCCAD] bg-[#FFF9ED] text-[#795D38]"}`}><span className={`h-2 w-2 rounded-full ${restaurant.referralAutoAcceptEnabled ? "bg-[#5D8B61]" : "bg-[#C28A45]"}`} />{restaurant.referralAutoAcceptEnabled ? "Rede ativa" : "Configuração pendente"}</span>
          </header>
