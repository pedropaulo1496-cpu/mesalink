                  ...
                  <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-center">
                    <div className="flex min-w-0 items-start gap-4">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2"><p className="text-lg font-semibold tracking-[-0.025em]">{adults} {adults === 1 ? "adulto" : "adultos"}{children > 0 ? ` · ${children} ${children === 1 ? "criança" : "crianças"}` : ""}</p>{isDemoGroup && <span className="rounded-full border border-[#E4BD72] bg-[#FFF3D7] px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.12em] text-[#8A5B16]">Demonstração</span>}<span className="rounded-full border border-[#D9C7AA] bg-white px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.12em] text-[#795D38]">{partnerType(group.partner.partnerType)} {isDemoGroup ? "teste" : "verificado"}</span></div>
