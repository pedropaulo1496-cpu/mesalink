              ...
              {visibleReferralOffers.map((offer) => {
                ...
                return <article key={offer.id} className="rounded-[20px] border border-[#E1D0B8] bg-[#FFFDFC] p-3 transition hover:border-[#C9AD83]">
                  <div className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_170px_270px] xl:items-center">
                    ...
                    <div className="rounded-[15px] border border-[#E5D6C0] bg-[#FFF7EA] px-3 py-2 xl:text-right"><p className="text-[7px] font-black uppercase tracking-[0.12em] text-[#9A7650]">Comissão base</p><p className="mt-0.5 text-sm font-bold text-[#704E27]">{formatMoney(commissionPerPerson)} / pessoa</p><p className="text-[9px] font-semibold text-[#8A7863]">{formatMoney(amounts.gross)} total · + impostos aplicáveis</p></div>
