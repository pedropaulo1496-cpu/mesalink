        ...
        <form onSubmit={submit} className="border-t border-[#E8DCCB] bg-[#FFF9F0] p-5">
          <div className="grid gap-5 xl:grid-cols-[1fr_0.92fr]">
            <div className="space-y-4">
              ...
              <div><label className="text-[10px] font-black uppercase tracking-[0.12em] text-[#806D56]">Nome da promoção</label><input name="title" required maxLength={100} defaultValue="Um convite especial para voltar" className="input-premium mt-2" /></div>
