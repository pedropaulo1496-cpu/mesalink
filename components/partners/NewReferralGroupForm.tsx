...
function RestaurantInviteActions({ restaurant }: { restaurant: PartnerRestaurant }) {
  ...
  return <InviteActionButton state={state} onClick={invite} label="Pedir reservas imediatas" />;
}
