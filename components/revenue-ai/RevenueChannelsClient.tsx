  ...
  return <div className="space-y-5">
    <section className="rounded-[26px] border border-[#E1D0B8] bg-white p-5">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        <SimpleChannel icon={<Mail size={20} />} title="Email MesaLink" status="Já funciona" text="Follow-up de clientes inativos e respostas individuais pela caixa Revenue AI." price="Usa os 1.000 emails mensais do Growth" active />
