...
export default function RevenueInboxClient({ restaurantId, restaurantName, initialCredits, initialConversations }: { restaurantId: string; restaurantName: string; initialCredits: number; initialConversations: Conversation[] }) {
